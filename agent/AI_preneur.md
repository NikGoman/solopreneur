...
- **Конкуренты или аналоги (обновлено):**  
  - **Прямые**:  
    - [aistroibot.ru](https://aistroibot.ru/) — Telegram-бот с генеративными ответами, но без подтверждённой привязки к нормативной базе (риск галлюцинаций).  
    - [star-pro.ru/proverka-standartov](https://star-pro.ru/proverka-standartov) — веб-сервис для проверки актуальности ГОСТ/СНиП по номеру или загруженному файлу; не интерактивный, не мобильный, не для полевых сценариев.  
  - **Косвенные**:  
...
- **Технический стек MVP (подтверждён):**  
  ...
  * **Требование к MVP**: поддержка ограниченного бесплатного режима (например, 3 запроса/день)
...
- **Анализ конкурентов (дополнено на основе knowledge base):**  
