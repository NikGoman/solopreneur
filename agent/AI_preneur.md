...
- **Стратегический фокус (обновлено):**  
  * Первые 30 дней — ручной cold outreach (цель: 5 платящих клиентов)  
  * Приоритет: подтверждение спроса и снижение CAC через кейсы и референсы  
  * Рассматривается введение тарифа $9.9/мес для увеличения конверсии
