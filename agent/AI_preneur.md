...
- Уникальное преимущество (если есть): глубокая предметная экспертиза основателя + low-code AI на open-source стеке  
...
- Финансовые метрики (если есть): пока нет  
- Обратная связь по гипотезам:  
  * [AI-ассистент для прорабов на базе RAG + ГОСТ/СНиП] → [гипотеза выбрана для тестирования]
